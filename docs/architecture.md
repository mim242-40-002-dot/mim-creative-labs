...
Mim Creative Labs is a dependency-free static website served from the repository root. `index.html` contains semantic content and landmarks; CSS is separated into design tokens, global foundations, components and responsive rules; `js/main.js` progressively enhances navigation and project-specific interactions.
